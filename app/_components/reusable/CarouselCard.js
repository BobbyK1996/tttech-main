...
function CarouselCard({ card, state }) {
  return (
    ...
    >
      ...
      <div
        className={`w-11/12 h-60 bg-blue-300 rounded-xl shadow-2xl bg-gradient-to-br from-space-950 via-primary-950 via-40% to-primary-900 to-100% flex flex-col justify-center items-center p-8 `}
      >
