...
function SubmitFormReview({ formData }) {
  ...
  return (
    <div className='grid grid-cols-[0.15fr,0.25fr,2.5fr,0.5fr] gap-x-2 gap-y-4 text-white sm:gap-x-4 lg:grid-cols-[0.1fr,0.25fr,2.5fr,0.5fr]'>
      {/* Name */}
      <div
      ...
      <div>
        {formDataTrimmed.linkedinLink ? `${formDataTrimmed.linkedinLink}` : '-'}
      </div>
      <div className={reviewItemStyles}>
