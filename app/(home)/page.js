...
import DodgingImage from '@components/reusable/heroImage';
...
function Page() {
  return (
    <>
      ...
      <section className="h-screen grid grid-cols-1 grid-rows-[1fr,auto,1.5fr] md:grid-rows-[1fr,auto,2fr] gap-4 z-10 md:text-xl">
